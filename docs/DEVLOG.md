...
| 2026-09-25 | Claude Code (Claude Opus 5.5, Anthropic) | perguntas para fechar as decisões (o aluno escolheu cada uma); primeira versão do código do transpilador, testes, README e especificação | implementação (Marcos 2 a 5) | suíte 10 de 10 (saídas conferidas à mão), gcc -Wall sem avisos, casos-limite, clone limpo | escolheu todas as decisões; (preencher) |
| 2026-09-25 | Claude Code (Claude Opus 5.5, Anthropic) | relatório do TP1, EI03 (PDF + zip) e roteiro da apresentação, gerados com as saídas reais | documentação / entrega | revisão por print do HTML; zip conferido | (preencher) |
